fun main(args: Array<String>) {
    ...
    val oneBillion : Long = 100000000L //Literal Long
    println("Contoh Literal Long : $oneBillion")
    val valHeksa = 0x0F //Literal heksadesimal diawali dengan 0x
    println("Contoh Literal valHeksa : $valHeksa")
    val valBinary = 0b00001011//Literal binary diawali dengan 0b
    println("Contoh Literal valBinary : $valBinary")
    val notasiKonversional = 123.5e10
    println("Contoh Literal notasiKonversional : $notasiKonversional")
